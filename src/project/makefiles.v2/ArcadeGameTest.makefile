...
Debug_Libraries=-Wl,--start-group gtest-1.7.0/lib/.libs/libgtest.a gtest-1.7.0/lib/.libs/libgtest_main.a -pthread -Wl,--end-group
...
.PHONY: Debug
Debug: create_folders gccDebug/tinyxml2.o gccDebug/Actor.o gccDebug/ArcadeGameTest.o gccDebug/ArcadeGameTest2.o gccDebug/ASCIIArtUIHandler.o gccDebug/AttackCommand.o gccDebug/Board.o gccDebug/Button.o gccDebug/Collision.o gccDebug/FileNames.o gccDebug/Gate.o gccDebug/Goal.o gccDebug/HtmlUIHandler.o gccDebug/Monster.o gccDebug/MoveCommand.o gccDebug/Obstacle.o gccDebug/ParseXML.o gccDebug/PieceBase.o gccDebug/Player.o gccDebug/TestHelpers.o gccDebug/TextUIHandler.o gccDebug/Trap.o gccDebug/UIHandlerBase.o gccDebug/Water.o gccDebug/XmlUIHandler.o
	$(CPP_COMPILER) gccDebug/tinyxml2.o gccDebug/Actor.o gccDebug/ArcadeGameTest.o gccDebug/ArcadeGameTest2.o gccDebug/ASCIIArtUIHandler.o gccDebug/AttackCommand.o gccDebug/Board.o gccDebug/Button.o gccDebug/Collision.o gccDebug/FileNames.o gccDebug/Gate.o gccDebug/Goal.o gccDebug/HtmlUIHandler.o gccDebug/Monster.o gccDebug/MoveCommand.o gccDebug/Obstacle.o gccDebug/ParseXML.o gccDebug/PieceBase.o gccDebug/Player.o gccDebug/TestHelpers.o gccDebug/TextUIHandler.o gccDebug/Trap.o gccDebug/UIHandlerBase.o gccDebug/Water.o gccDebug/XmlUIHandler.o $(Debug_Library_Path) $(Debug_Libraries) -Wl,-rpath,./ -o gccDebug/ArcadeGameTest
...
# Compiles file ArcadeGameTest2.cpp for the Debug configuration...
-include gccDebug/ArcadeGameTest2.d
gccDebug/ArcadeGameTest2.o: ArcadeGameTest2.cpp
	$(CPP_COMPILER) $(Debug_Preprocessor_Definitions) $(Debug_Compiler_Flags) -c ArcadeGameTest2.cpp $(Debug_Include_Path) -o gccDebug/ArcadeGameTest2.o
	$(CPP_COMPILER) $(Debug_Preprocessor_Definitions) $(Debug_Compiler_Flags) -MM ArcadeGameTest2.cpp $(Debug_Include_Path) > gccDebug/ArcadeGameTest2.d
...
# Compiles file TestHelpers.cpp for the Debug configuration...
-include gccDebug/TestHelpers.d
gccDebug/TestHelpers.o: TestHelpers.cpp
	$(CPP_COMPILER) $(Debug_Preprocessor_Definitions) $(Debug_Compiler_Flags) -c TestHelpers.cpp $(Debug_Include_Path) -o gccDebug/TestHelpers.o
	$(CPP_COMPILER) $(Debug_Preprocessor_Definitions) $(Debug_Compiler_Flags) -MM TestHelpers.cpp $(Debug_Include_Path) > gccDebug/TestHelpers.d
...
.PHONY: Release
Release: create_folders gccRelease/tinyxml2.o gccRelease/Actor.o gccRelease/ArcadeGameTest.o gccRelease/ArcadeGameTest2.o gccRelease/ASCIIArtUIHandler.o gccRelease/AttackCommand.o gccRelease/Board.o gccRelease/Button.o gccRelease/Collision.o gccRelease/FileNames.o gccRelease/Gate.o gccRelease/Goal.o gccRelease/HtmlUIHandler.o gccRelease/Monster.o gccRelease/MoveCommand.o gccRelease/Obstacle.o gccRelease/ParseXML.o gccRelease/PieceBase.o gccRelease/Player.o gccRelease/TestHelpers.o gccRelease/TextUIHandler.o gccRelease/Trap.o gccRelease/UIHandlerBase.o gccRelease/Water.o gccRelease/XmlUIHandler.o
	$(CPP_COMPILER) gccRelease/tinyxml2.o gccRelease/Actor.o gccRelease/ArcadeGameTest.o gccRelease/ArcadeGameTest2.o gccRelease/ASCIIArtUIHandler.o gccRelease/AttackCommand.o gccRelease/Board.o gccRelease/Button.o gccRelease/Collision.o gccRelease/FileNames.o gccRelease/Gate.o gccRelease/Goal.o gccRelease/HtmlUIHandler.o gccRelease/Monster.o gccRelease/MoveCommand.o gccRelease/Obstacle.o gccRelease/ParseXML.o gccRelease/PieceBase.o gccRelease/Player.o gccRelease/TestHelpers.o gccRelease/TextUIHandler.o gccRelease/Trap.o gccRelease/UIHandlerBase.o gccRelease/Water.o gccRelease/XmlUIHandler.o $(Release_Library_Path) $(Release_Libraries) -Wl,-rpath,./ -o gccRelease/ArcadeGameTest
...
# Compiles file ArcadeGameTest2.cpp for the Release configuration...
-include gccRelease/ArcadeGameTest2.d
gccRelease/ArcadeGameTest2.o: ArcadeGameTest2.cpp
	$(CPP_COMPILER) $(Release_Preprocessor_Definitions) $(Release_Compiler_Flags) -c ArcadeGameTest2.cpp $(Release_Include_Path) -o gccRelease/ArcadeGameTest2.o
	$(CPP_COMPILER) $(Release_Preprocessor_Definitions) $(Release_Compiler_Flags) -MM ArcadeGameTest2.cpp $(Release_Include_Path) > gccRelease/ArcadeGameTest2.d
...
# Compiles file TestHelpers.cpp for the Release configuration...
-include gccRelease/TestHelpers.d
gccRelease/TestHelpers.o: TestHelpers.cpp
	$(CPP_COMPILER) $(Release_Preprocessor_Definitions) $(Release_Compiler_Flags) -c TestHelpers.cpp $(Release_Include_Path) -o gccRelease/TestHelpers.o
	$(CPP_COMPILER) $(Release_Preprocessor_Definitions) $(Release_Compiler_Flags) -MM TestHelpers.cpp $(Release_Include_Path) > gccRelease/TestHelpers.d
